...
'#Tools {width:206px;background:#5563B0;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #2E3665;background:#979FCE;}'+
'#Title {width:206px;background:#CAD3E8;border-bottom:1px solid #000;}'+
...
'#SelectYear,#SelectMonth{position:absolute;top:21px;width=100%;z-index:1;overflow:hidden;display:none;border:0px solid #000}'+
'--></style><scr'+
...
'<div id="SelectMonth" style="left:100px;" onclick="ShowSelect(\'SelectMonth\',\'M\');"><div id="Select"><a href="javascript:;" onmousedown="mdown=window.setInterval(\'Scroll(\\\'Up\\\',\\\'M\\\')\',50);" onmouseup="window.clearInterval(mdown);" onmouseout="window.clearInterval(mdown);" id="SelectBn" style="border-bottom:1px solid #5563B0;"><font face="Webdings">5</font></a><div id="SelectMonthItem">'+
...
function Calendar_Show(year,month,day)
{
 var content;
 var date=new Date();
 var DayNum=(IsLeapYear(year)&&month==2)?MonthDNum[month]+1:MonthDNum[month];// IsLeapYear(year)&&month==2是否为闰年
 ...
 '<li style="width:144px;background:#FFF;padding-bottom:1px;" id="SelectArea"><div id="sYear">'+year+'</div><div id="SArr" onclick="ShowSelect(\'SelectYear\',\'Y\');"><font face="Webdings">6</font></div>'+
 ...
 if(Calendar_obj2){content+='<li style="width:42px;"><a href="javascript:parent.Calendar_GetDate('+year+','+month+',0);">this month</a></li>'+
 '<li style="width:43px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">today</a></li>';}
 else{content+='<li style="width:86px;"><a href="javascript:parent.Calendar_GetDate('+date.getFullYear()+','+(date.getMonth()+1)+','+date.getDate()+');">select today</a></li>';}
 content+='<li><a href="javascript:parent.Calendar_Modif('+year+','+(month+1)+','+day+');">></a></li>'+
 '<li><a href="javascript:parent.Calendar_Modif('+(year+1)+','+month+','+day+');">>></a></li>'+
 '</ul></div>'+
 '<div id="Title"><ul><li style="color:#F00;">Sun</li><li>M</li><li>T</li><li>W</li><li>T</li><li>F</li><li style="color:#F00;"></li>S</ul></div>'+
